...
public class ChargeViewfinderView extends ViewfinderView{
     ...
     * 边角线颜色
     */
    public int mLineColor = Color.parseColor("#3B74FA");
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x003B74FA, Color.parseColor("#3B74FA"), 0x003B74FA};



    public ChargeViewfinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
